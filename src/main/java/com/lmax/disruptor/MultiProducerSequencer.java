...
public final class MultiProducerSequencer extends AbstractSequencer
{
    ...
    /***
     * 获取用户给定数组寻址的换算因子.这个返回值能够与arrayBaseOffset一起使用去存取这个数组class中的元素
     */
    ...
    private void setAvailableBufferValue(int index, int flag)
    {
        ...
        long bufferAddress = (index * SCALE) + BASE; //定位数组每个值的地址 (index * SCALE) + BASE
    ...
    public boolean isAvailable(long sequence)
    {
        ...
        long bufferAddress = (index * SCALE) + BASE; //定位数组每个值的地址就是(index * SCALE) + BASE
